...
public class gGameView extends GridLayout {
	private Card[][] cardMap = new Card[4][4];
	private List<Point> emptyPoints = new ArrayList<Point>();
	public static int igGameViewWidth=500;

	public gGameView(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initgGameView();
		System.out.println("gGameView_gGameView");
		addRandomNum();
		System.out.println("gGameView_gGameView");
		addRandomNum();
		System.out.println("gGameView_gGameView");
	...
	public gGameView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		initgGameView();
		System.out.println("gGameView_gGameView");
	...
	public gGameView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initgGameView() {
		setColumnCount(4);
		setBackgroundColor(0xffbdada0);
		LayoutParams lp =new LayoutParams();
		lp.height=igGameViewWidth;
		lp.width=igGameViewWidth;
		setLayoutParams(lp);
		
		System.out.println("gGameView_initgGameView");
		
		int iCardWidth = (igGameViewWidth - 16) / 4;
